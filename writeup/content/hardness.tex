...
The second corollary of \cref{thm: finegrainedrowshard} is a generalization of Proposition A.2 in \cite{bafna-hsieh-kothari} to composite $k$. We show that, given an almost-$k$-colorable graph with balanced color classes, assuming the UGC, it is NP-hard to find a linear-sized independent set in the graph.
