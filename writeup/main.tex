...
\usepackage{etoolbox} % for \protected@xdef
...
\newcommand*\widefbox[1]{\fbox{\hspace{2em}#1\hspace{2em}}}
   \usepackage{hyperref}
%\hypersetup{hyperindex=true,pdfpagemode=UseOutlines,bookmarksnumbered=true,bookmarksopen=true,bookmarksopenlevel=2,pdfstartview=FitH,pdfborder={0 0 1},linkbordercolor=dt@linkcolor,citebordercolor=dt@linkcolor,urlbordercolor=dt@linkcolor}
...
\begin{document}
%\makeatletter
%\forcsvlist{\expandafter\newtheorem*\expandafter{\csname ##1*\endcsname}{\csname ##1\endcsname}}{lemma,theorem,definition,proposition,corollary,fact,remark,claim}
%\makeatother
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
